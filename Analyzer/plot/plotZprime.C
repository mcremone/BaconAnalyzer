...
void plotZprime(const string selection, const string algo, const string jet, float cut, float csv)
{
  ...
  samplev.back()->fnamev.push_back("/tmp/cmantill/W.root");
  samplev.push_back(new CSample("Z+jets", kCyan - 9, kCyan - 9));
  samplev.back()->fnamev.push_back("/tmp/cmantill/DY.root");
  samplev.push_back(new CSample("Diboson",kRed - 9,kRed - 9));
  samplev.back()->fnamev.push_back("/tmp/cmantill/Diboson.root");
  samplev.push_back(new CSample("t#bar{t}",kOrange - 3,kOrange - 3));
  samplev.back()->fnamev.push_back("/tmp/cmantill/TTbar_madgraphMLM.root");
  samplev.push_back(new CSample("m_{Z'}=100 GeV",2,2));
  samplev.back()->fnamev.push_back("/tmp/cmantill/VectorDiJet1Jet_M100.root");
  samplev.push_back(new CSample("m_{Z'}=125 GeV",4,4));
  samplev.back()->fnamev.push_back("/tmp/cmantill/VectorDiJet1Jet_M125.root");
  samplev.push_back(new CSample("m_{Z'}=150 GeV",6,6));
  samplev.back()->fnamev.push_back("/tmp/cmantill/VectorDiJet1Jet_M150.root");
  samplev.push_back(new CSample("m_{Z'}=200 GeV",7,7));
  samplev.back()->fnamev.push_back("/tmp/cmantill/VectorDiJet1Jet_M200.root");
  samplev.push_back(new CSample("m_{Z'}=250 GeV",8,8));
  samplev.back()->fnamev.push_back("/tmp/cmantill/VectorDiJet1Jet_M250.root");
  samplev.push_back(new CSample("m_{Z'}=300 GeV",3,3));
  samplev.back()->fnamev.push_back("/tmp/cmantill/VectorDiJet1Jet_M300.root");
  ...
  //
  char hname[100];
  vector<TH1D*> hFatJetMassv, hFatJetTau21v, hFatJetTau21DDTv, hFatJetRhoDDTv, hFatJetRhoDDTlv, hFatJetMassNew, hFatJetMassNewt;     
  ...
  for(unsigned int isam=0; isam<12; isam++) {
    ...
    for(unsigned int ifile=0; ifile<sample->fnamev.size(); ifile++) {
      ...
      if(isam ==2 || isam == 3 || isam == 6 || isam == 7 || isam == 8 || isam == 9 || isam ==10 || isam ==11){ 
