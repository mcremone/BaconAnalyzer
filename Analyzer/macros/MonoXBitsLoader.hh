...
public:
  ...
  bool passBoosted15MonoHbbBambuPreselection(string preselection);
  bool passResolvedMonoHbbPreselection(string preselection);
  bool passResolvedMonoHbbBambuPreselection(string preselection);
  ...
  bool passSemiResolvedMonoTopBambuSR(string preselection);
  bool passSemiResolvedMonoTopBambuTopCR(string preselection);
  bool passSemiResolvedMonoTopBambuWCR(string preselection);
  bool passSemiResolvedMonoTopBambuZCR(string preselection);
  ...
  bool passBoosted15MonoHbbBambuSR(string preselection, float csvb0 = 0.3, float csvb1 = 1000);
  bool passBoosted15MonoHbbBambuTopCR(string preselection, float csvb0 = 0.3, float csvb1 = 1000);
  bool passBoosted15MonoHbbBambuWCR(string preselection, float csvb0 = 0.3, float csvb1 = 1000);
  bool passBoosted15MonoHbbBambuZCR(string preselection);
  ...
  bool passResolvedMonoHbbBambuSR(string preselection);
  bool passResolvedMonoHbbBambuTopCR(string preselection);
  bool passResolvedMonoHbbBambuWCR(string preselection);
  bool passResolvedMonoHbbBambuZCR(string preselection);
