...
#root -b plotZprime.C+\(\"${selection}\"\,\"${algo}\"\,\"${jet}\",0.38,-0.9\) -b plotZprime.C+\(\"${selection}\"\,\"${algo}\"\,\"${jet}\",0.38,-0.6\) -b plotZprime.C+\(\"${selection}\"\,\"${algo}\"\,\"${jet}\",0.38,-0.3\) -b  plotZprime.C+\(\"${selection}\"\,\"${algo}\"\,\"${jet}\",0.38,0.0\) -b  plotZprime.C+\(\"${selection}\"\,\"${algo}\"\,\"${jet}\",0.38,0.3\)  -b  plotZprime.C+\(\"${selection}\"\,\"${algo}\"\,\"${jet}\",0.38,0.6\)  -b  plotZprime.C+\(\"${selection}\"\,\"${algo}\"\,\"${jet}\",0.38,0.9\)
