...
void RecoilCorrector::covMatrix(TMatrixD &iCov,double iGenPt, double iGenPhi, int njet) {
  fJet = njet; if(njet > 2) fJet = 2;  
  if(fJet >= int(fF1U1Fit.size())) fJet = 0; 
  double lSigma1 = fF1U1RMSSMFit[fJet]->Eval(iGenPt);
  double lSigma2 = fF1U2RMSSMFit[fJet]->Eval(iGenPt);
...
void RecoilCorrector::metDistribution(double &iMet,double &iMPhi,double iGenPt,double iGenPhi,
  ...
  double pVal1_1   = pCorr1*pSigma1_1;
  double pVal2_1   = pCorr2*pSigma2_1;
...
void RecoilCorrector::metDistribution(double &iPFMet,double &iPFMPhi,double &iTKMet,double &iTKMPhi,
  ...
  ///
  double pPFU1       = CorrVal(iGenPt,iU1RPFFit->Eval(iGenPt)-iGenPt,PFU1);
  double pPFU2       = 0;
  ...
  double pTKU1       = CorrVal(iGenPt,iU1RTKFit->Eval(iGenPt)+iGenPt,TKU1);
  double pTKU2       = 0;
