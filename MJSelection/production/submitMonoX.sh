...
#     ./sub.sh mcwjets $eos WJetsToLNu_HT_100To200_13TeV                                                           1343  $dir $exec $option1 $option2
#     ./sub.sh mcwjets $eos WJetsToLNu_HT_200To400_13TeV                                                          359.6  $dir $exec $option1 $option2
#     ./sub.sh mcwjets $eos WJetsToLNu_HT_400To600_13TeV                                                          48.85  $dir $exec $option1 $option2
#     ./sub.sh mcwjets $eos WJetsToLNu_HT_600ToInf_13TeV                                                          18.91  $dir $exec $option1 $option2
# fi
...
#     ./sub.sh mcdyjets $eos DYJetsToLL_M_50_HT_100to200_13TeV                                                    148.0  $dir $exec $option1 $option2
#     ./sub.sh mcdyjets $eos DYJetsToLL_M_50_HT_200to400_13TeV                                                    40.94  $dir $exec $option1 $option2 
#     ./sub.sh mcdyjets $eos DYJetsToLL_M_50_HT_400to600_13TeV                                                    5.497  $dir $exec $option1 $option2
#     ./sub.sh mcdyjets $eos DYJetsToLL_M_50_HT_600toInf_13TeV                                                    2.193  $dir $exec $option1 $option2 
# fi
...
#     ./sub.sh mczjets $eos Spring15_a25ns_ZJetsToNuNu_HT-100To200_MINIAOD                                        280.5  $dir $exec $option1 $option2
#     ./sub.sh mczjets $eos Spring15_a25ns_ZJetsToNuNu_HT-200To400_MINIAOD                                         77.7  $dir $exec $option1 $option2
#     ./sub.sh mczjets $eos Spring15_a25ns_ZJetsToNuNu_HT-400To600_MINIAOD                                        10.71  $dir $exec $option1 $option2
#     ./sub.sh mczjets $eos Spring15_a25ns_ZJetsToNuNu_HT-600ToInf_MINIAOD                                        4.098  $dir $exec $option1 $option2
# fi
# if [[ ($sample = "All") || ($sample != "All" && $sample = "ZHF") ]]; then
#     ./sub.sh mczplushf $eos Spring15_a25ns_ZJetsToNuNu_HT-100To200_MINIAOD                                      280.5  $dir $exec $option1 $option2
#     ./sub.sh mczplushf $eos Spring15_a25ns_ZJetsToNuNu_HT-200To400_MINIAOD                                       77.7  $dir $exec $option1 $option2
#     ./sub.sh mczplushf $eos Spring15_a25ns_ZJetsToNuNu_HT-400To600_MINIAOD                                      10.71  $dir $exec $option1 $option2
#     ./sub.sh mczplushf $eos Spring15_a25ns_ZJetsToNuNu_HT-600ToInf_MINIAOD                                      4.098  $dir $exec $option1 $option2
# fi
# if [[ ($sample = "All") || ($sample != "All" && $sample = "ZLF") ]]; then
#     ./sub.sh mczpluslf $eos Spring15_a25ns_ZJetsToNuNu_HT-100To200_MINIAOD                                      280.5  $dir $exec $option1 $option2
#     ./sub.sh mczpluslf $eos Spring15_a25ns_ZJetsToNuNu_HT-200To400_MINIAOD                                       77.7  $dir $exec $option1 $option2
#     ./sub.sh mczpluslf $eos Spring15_a25ns_ZJetsToNuNu_HT-400To600_MINIAOD                                      10.71  $dir $exec $option1 $option2
#     ./sub.sh mczpluslf $eos Spring15_a25ns_ZJetsToNuNu_HT-600ToInf_MINIAOD                                      4.098  $dir $exec $option1 $option2
# fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTZ") ]]; then
    ./sub.sh mc $eos Spring15_a25ns_TTZToLLNuNu_M-10_MINIAOD                                                   0.2529  $dir $exec $option1 $option2;
fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TT") ]]; then
    ./sub.sh mctt $eos Spring15_a25ns_TTJets_madgraph_MINIAOD                                                  831.76  $option1 $option2;
fi
# if [[ ($sample = "All") || ($sample != "All" && $sample = "TT1L") ]]; then
#     ./sub.sh mctt1l $eos Spring15_a25ns_TTJets_madgraph_MINIAOD                                                831.76  $dir $exec $option1 $option2; 
# fi
# if [[ ($sample = "All") || ($sample != "All" && $sample = "TT2L") ]]; then
#     ./sub.sh mctt2l $eos Spring15_a25ns_TTJets_madgraph_MINIAOD                                                831.76  $dir $exec $option1 $option2; 
# fi
# if [[ ($sample = "All") || ($sample != "All" && $sample = "TTHAD") ]]; then
#     ./sub.sh mctthad $eos Spring15_a25ns_TTJets_madgraph_MINIAOD                                               831.76  $dir $exec $option1 $option2; 
# fi
# if [[ ($sample = "All") || ($sample != "All" && $sample = "TTBST") ]]; then
#     ./sub.sh mcttbst $eos Spring15_a25ns_TTJets_madgraph_MINIAOD                                               831.76  $dir $exec $option1 $option2; 
# fi
# if [[ ($sample = "All") || ($sample != "All" && $sample = "TTCOM") ]]; then
#     ./sub.sh mcttcom $eos Spring15_a25ns_TTJets_madgraph_MINIAOD                                               831.76  $dir $exec $option1 $option2; 
# fi
...
#     ./sub.sh mcgjets $eos Spring15_a25ns_GJets_HT-100To200_MINIAOD                                               9235  $dir $exec $option1 $option2
#     ./sub.sh mcgjets $eos Spring15_a25ns_GJets_HT-200To400_MINIAOD                                               2298  $dir $exec $option1 $option2
#     ./sub.sh mcgjets $eos Spring15_a25ns_GJets_HT-400To600_MINIAOD                                              277.6  $dir $exec $option1 $option2
#     ./sub.sh mcgjets $eos Spring15_a25ns_GJets_HT-600ToInf_MINIAOD                                              93.47  $dir $exec $option1 $option2
# fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "MonoTop") ]]; then
    ./sub.sh mc $eos Spring15_a25ns_Monotop_S1_Mres-1100_Mchi-100_MINIAOD                                           1  $dir $exec $option1 $option2
...
#     ./sub.sh mc $eos Spring15_a25ns_Monotop_S4_Mchi-1500_MINIAOD                                                    1  $dir $exec $option1 $option2
    ./sub.sh mc $eos Spring15_a25ns_Monotop_S4_Mchi-300_MINIAOD                                                     1  $dir $exec $option1 $option2
