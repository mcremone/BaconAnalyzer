...
#   ./sub.sh mcwplushf $eos  WJetsToLNu_13TeV_amcatnloFXFX_pythia8                                               61527 $dir $exec $option1 $option2
...
#   ./sub.sh mcwpluslf $eos  WJetsToLNu_13TeV_amcatnloFXFX_pythia8                                               61527 $dir $exec $option1 $option2
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "MET") ]]; then 
    ./sub.sh data $eos METRun2016B_PromptReco_v1                                                                    1  $dir $exec $option1 $option2
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "SinglePhoton") ]]; then
   ./sub.sh data $eos SinglePhotonRun2016B_PromptReco_v1                                                            1  $dir $exec $option1 $option2
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "SingleElectron") ]]; then
    ./sub.sh data $eos SingleElectronRun2016B_PromptReco_v1                                                         1  $dir $exec $option1 $option2
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTDM") ]]; then
   ./sub.sh mc $eos TTbarDMJets_pseudoscalar_Mchi_1_Mphi_100_13TeV_ext                                              1  $dir $exec $option1 $option2
fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "ZH") ]]; then
    ...
    ./sub.sh mc $eos ZH_HToBB_ZToNuNu_M125_13TeV_amcatnloFXFX_madspin_pythia8                                   0.159  $dir $exec $option1 $option2
fi