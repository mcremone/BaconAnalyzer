...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TT") ]]; then
    ./sub.sh mctt $eos TTJets_13TeV_amcatnloFXFX_pythia8_2                                                     831.76  $option1 $option2;
fi
...
#     ./sub.sh mc $eos Fall15_GluGlu_HToInvisible_M300_13TeV_powheg_pythia8                                           1  $dir $exec $option1 $option2
