...
if [[ ($sample = "All") || ($sample != "All" && $sample = "MonoTop") ]]; then
    for x in `ls ../baconbits | grep DMJetsMonotop | grep -v .root`; do
	rm ../baconbits/$x.root
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTBST") ]]; then rm ../baconbits/TTBST.root;   hadd  ../baconbits/TTBST.root    ../baconbits/Spring15_a25ns_TTJets_madgraph_MINIAOD*mcbst/*.root; fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTCOM") ]]; then rm ../baconbits/TTCOM.root;   hadd  ../baconbits/TTCOM.root    ../baconbits/Spring15_a25ns_TTJets_madgraph_MINIAOD*mccom/*.root; fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "MET") ]]; then rm ../baconbits/MET.root; hadd  ../baconbits/MET.root   ../baconbits/MET_*v3_data/*.root; fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "SinglePhoton") ]]; then rm ../baconbits/SinglePhoton.root; hadd  ../baconbits/SinglePhoton.root   ../baconbits/SinglePhoton_*v3_data/*.root; fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTherwigBST") ]]; then rm ../baconbits/TTherwigBST.root;   hadd  ../baconbits/TTherwigBST.root    ../baconbits/Spring15_a25ns_TT_powheg_herwig_MINIAOD*mcbst/*.root; fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTherwigCOM") ]]; then rm ../baconbits/TTherwigCOM.root;   hadd  ../baconbits/TTherwigCOM.root    ../baconbits/Spring15_a25ns_TT_powheg_herwig_MINIAOD*mccom/*.root; fi
