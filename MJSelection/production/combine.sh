...
if [[ ($sample = "All") || ($sample != "All" && $sample = "MonoTop") ]]; then
    for x in `ls ../MonoXbits | grep DMJetsMonotop | grep -v .root`; do
	rm ../MonoXbits/$x.root
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTBST") ]]; then rm ../MonoXbits/TTBST.root;   hadd  ../MonoXbits/TTBST.root    ../MonoXbits/Spring15_a25ns_TTJets_madgraph_MINIAOD*mcbst/*.root; fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTCOM") ]]; then rm ../MonoXbits/TTCOM.root;   hadd  ../MonoXbits/TTCOM.root    ../MonoXbits/Spring15_a25ns_TTJets_madgraph_MINIAOD*mccom/*.root; fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "MET") ]]; then rm ../MonoXbits/MET.root; hadd  ../MonoXbits/MET.root   ../MonoXbits/MET_*v3_data/*.root; fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "SinglePhoton") ]]; then rm ../MonoXbits/SinglePhoton.root; hadd  ../MonoXbits/SinglePhoton.root   ../MonoXbits/SinglePhoton_*v3_data/*.root; fi
...
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTherwigBST") ]]; then rm ../MonoXbits/TTherwigBST.root;   hadd  ../MonoXbits/TTherwigBST.root    ../MonoXbits/Spring15_a25ns_TT_powheg_herwig_MINIAOD*mcbst/*.root; fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "TTherwigCOM") ]]; then rm ../MonoXbits/TTherwigCOM.root;   hadd  ../MonoXbits/TTherwigCOM.root    ../MonoXbits/Spring15_a25ns_TT_powheg_herwig_MINIAOD*mccom/*.root; fi
