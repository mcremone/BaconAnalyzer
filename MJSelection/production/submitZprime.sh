...
if [[ ($sample = "All") || ($sample != "All" && $sample = "GHF") ]]; then
    ./sub.sh mcgplushgf $eos GJets_HT_100To200_13TeV                                                              9235  $dir $exec $option1 $option2
    ./sub.sh mcgplushgf $eos GJets_HT_200To400_13TeV                                                              2298  $dir $exec $option1 $option2
    ./sub.sh mcgplushgf $eos GJets_HT_400To600_13TeV                                                             277.6  $dir $exec $option1 $option2
    ./sub.sh mcgplushgf $eos GJets_HT_600ToInf_13TeV                                                             93.47  $dir $exec $option1 $option2
fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "GLF") ]]; then
    ./sub.sh mcgpluslgf $eos GJets_HT_100To200_13TeV                                                              9235  $dir $exec $option1 $option2
    ./sub.sh mcgpluslgf $eos GJets_HT_200To400_13TeV                                                              2298  $dir $exec $option1 $option2
    ./sub.sh mcgpluslgf $eos GJets_HT_400To600_13TeV                                                             277.6  $dir $exec $option1 $option2
    ./sub.sh mcgpluslgf $eos GJets_HT_600ToInf_13TeV                                                             93.47  $dir $exec $option1 $option2
fi
