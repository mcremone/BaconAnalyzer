...
if [[ ($sample = "All") || ($sample != "All" && $sample = "GHF") ]]; then rm ../zprimebits/GHF80_2.root;    hadd  ../zprimebits/GHF80_2.root     ../zprimebits/*GJets*_HT*mcgplushgf/*.root; fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "GLF") ]]; then rm ../zprimebits/GLF80_2.root;    hadd  ../zprimebits/GLF80_2.root     ../zprimebits/*GJets*_HT*mcgpluslgf/*.root; fi
if [[ ($sample = "All") || ($sample != "All" && $sample = "SinglePhoton") ]]; then rm ../zprimebits/SinglePhotontrig4.root; hadd  ../zprimebits/SinglePhotontrig4.root   ../zprimebits/SinglePhoton*data/*.root; fi
