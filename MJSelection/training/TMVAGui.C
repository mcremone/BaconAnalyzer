...
// main GUI
void TMVAGui( const char* fName = "tmva_output/TMVA_=QCDvsCA15_MaxSubjetBtagZandT.root")
//TMVA_=QCDvsCA15_SubjetBtagScoresNoTau32.root")
//TMVA_=QCDvsCA15_MaxSubjetBtagNoTau32.root")//TMVACategoryPuId_rho_cat.root")//TMVACategoryPuId_1Feb.root")//TMVA_noCategoryPuId1Feb.root")//TMVACategoryPuId.root" ) 
{   
