...
def getPerformanceCurve(fFileS1, fFileB1, pTmin, pTmax, fXMin=0, fXMax=0):
    ...
    file_S174 = TFile("Training_without/validation/validation_Zprime_033_1_svmass_topS08topM14Pt250_033.root")
    file_B174 = TFile("Training_without/validation/validation_QCD_033_1_svmass_topS08topM14Pt250_033.root")
    '''
    file_S1w = TFile("Training_with/validation/validation_Zprime_2_svmass_Zprime075QCD025_withmaxsubjetcsv.root")
    file_B1w = TFile("Training_with/validation/validation_QCD_even_2_svmass_Zprime075QCD025_withmaxsubjetcsv.root")  
    ...
    for event in treeS:
        ...
        #bdtg_pt = event.BDTG -  0.000925003*event.bst15_PUPPIjet0_pt
    ...
    for event in treeSw:
        ...
        #bdtg_ptw =event.BDTG -  0.000925003*event.bst15_PUPPIjet0_pt
        if(event.maxsubjetcsv < -1):
            subjetcsvw = -1
        elif(event.maxsubjetcsv >1):
            subjetcsvw = -1
...
def makePlots():
   ...
   plotPerformanceCurves(mg15PUPPI,ordering,"","Tagging efficiency (Singleb)","Mistagging efficiency","CA15 PUPPI Pt > 250","roc7476_comparisonZPrime75QCD25.pdf",0, 1, 1E-3, 1, 1)
