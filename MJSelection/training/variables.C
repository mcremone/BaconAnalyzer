...
void variables( TString fin = "Training_with/tmva_output/TMVA_svmass_test_withptcut.root", TString dirName = "InputVariables_Id", TString title = "TMVA Input Variables",
		  Bool_t isRegression = kFALSE, Bool_t useTMVAStyle = kTRUE )
{
